		...
		$this->start_controls_section(
            ...
            $this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
						'.elementor-widget-container #ova-blog-slider-control button, .elementor-widget-container #ova-blog-slider-control-2 button ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
					...
					<li class="item">
						...
						<?php if(has_post_thumbnail()){ ?>
						    ...
						    <div class="media">
					        	...
					        	<?php if( $show_category == 'yes' && $template == 'template1'){ ?>
						        	<span class="category">

...
class ova_team_slider extends Widget_Base {
	...
	public function get_script_depends() {
		wp_enqueue_style( 'team-owl-carousel', OVATEAM_PLUGIN_URI.'assets/libs/owl-carousel/assets/owl.carousel.min.css' );
		wp_enqueue_script( 'team-owl-carousel', OVATEAM_PLUGIN_URI.'assets/libs/owl-carousel/owl.carousel.min.js', array('jquery'), false, true );
